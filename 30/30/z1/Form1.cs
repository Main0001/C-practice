...
namespace _30_1
{
    public partial class Form1 : Form
    {
        ...
        private string pathToDB = @"G:\Колледж\Git\C-practice\30\30\z1\DBTur_firm.mdf";
        ...
        {
            editTableForm editTable = new editTableForm();
        ...
        private void toolStripLabel3_Click(object sender, EventArgs e)
        {
            ...
            editTable.type = "edit";
            editTable.id = dataGridView2[0, currentCell[0].RowIndex].Value.ToString();
            editTable.ShowDialog();
        }
    }
}
