...
string path = @"D:\Git projects\C-practice\day17\Task\additional 3(v1)\bin\Debug\testyarlikov";
...
try
{
    ...
    if (Directory.Exists(path))
    {
        ...
        File.Copy(Path.Combine(@"D:\Git projects\C-practice\day17\Task\additional 3(v1)\bin\Debug\net6.0", "file1.txt"), _pathFile, true);
