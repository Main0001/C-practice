...
namespace z3
{
    public partial class Form1 : Form
    {
        ...
        List<SetBP> list = new List<SetBP>(); 
        ...
        private void Form1_Paint_1(object sender, PaintEventArgs e)
        {
            ...
            foreach (SetBP steam in list) steam.DrawHouse(e);
        }
    }
    ...
    class SetBP
    {
        ...
        public void DrawHouse(PaintEventArgs e)
        {
            for (int i = 0; i < 2; i++)
            {
